...
<html>
	...
	<body>
		...
		<div class="float-right">
			<input type="button" class = "btn btn-primary" onclick="location.href='http://localhost/assign/addcustomer.html';" value="Add A Customer" />
		</div>
		...
		<table class="table">
			...
			<?php foreach($result as $row): ?>
				<tr>
					...
					<td><?php echo $row["inputEmail"]; ?></td>
					<td><?php echo $row["inputPhone"]; ?></td>
					<td>
						<div class="btn-group">
